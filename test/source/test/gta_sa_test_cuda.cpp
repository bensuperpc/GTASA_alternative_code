...
TEST(GTASAEngine, basic_calc_cuda_1) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request = gtaSA.addRequest("CUDA", 0, 6'000'000);
...
TEST(GTASAEngine, basic_calc_cuda_2) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request = gtaSA.addRequest("CUDA", 20'810'700, 20'810'800);
    gtaSA.waitAllRequests();
...
TEST(GTASAEngine, basic_calc_cuda_3) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request = gtaSA.addRequest("CUDA", 181'961'000, 181'961'100);
    gtaSA.waitAllRequests();
...
TEST(GTASAEngine, basic_calc_cuda_4) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request = gtaSA.addRequest("CUDA", 299'376'700, 299'376'800);
    gtaSA.waitAllRequests();
...
TEST(GTASAEngine, basic_calc_cuda_5) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request = gtaSA.addRequest("CUDA", 0, 5'200'000'000);
    gtaSA.waitAllRequests();
...
TEST(GTASAEngine, multi_calc_cuda_1) {
    GTASAEngine gtaSA = GTASAEngine();
    GTASARequest* request1 = gtaSA.addRequest("CUDA", 0, 182'000'000);
    GTASARequest* request2 = gtaSA.addRequest("CUDA", 182'000'000, 300'000'000);
    GTASARequest* request3 = gtaSA.addRequest("CUDA", 300'000'000, 545'000'000);
    gtaSA.waitAllRequests();
