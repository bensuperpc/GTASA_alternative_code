...
uint32_t my::opencl::jamcrc(const void* data, const uint64_t length, const uint32_t previousCrc32) {
    ...
    static std::string kernelSourceStr = my::opencl::kernel::jamcrcTable() + my::opencl::kernel::jamcrc1Byte();
...
void my::opencl::launchKernel(std::vector<uint32_t>& jamcrc_results,
    ...
    static std::string kernelSourceStr = my::opencl::kernel::jamcrcTable() + my::opencl::kernel::jamcrc1ByteLocal() +
                                         my::opencl::kernel::generateStringLocal() + my::opencl::kernel::cheatListTable() +
                                         my::opencl::kernel::findAlternativeCheat();
