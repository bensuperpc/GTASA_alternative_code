...
{ find . ! -name . \( -name 'GTA_SA_cheat_finder*' -o -name '*.sha256' \) ! \( -name '*.*' -o -name '*.*' \) && find .. -maxdepth 1 -type f -name '*.md' && find .. -maxdepth 1 -type f -name '*.sha256'; } | XZ_OPT=-e9 tar -cJf ../gta-local.tar.xz -T -
